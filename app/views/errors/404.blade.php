...
<html lang="en">
  <head>
    ...
    <title>404 - Quanto se ganha?</title>
      ...
      <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
          ...
          <div class="inner cover">
            <h1 class="cover-heading">Não encontrado!</h1>
            <p class="lead">
                Pedimos desculpa, mas não encontrámos a página que pediu, caso ache que esta página deveria existir, não exite em contactar o webmaster.
            </p>
          </div>
